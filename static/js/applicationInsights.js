// This loads application insights if enabled on the server.
// Note: contents of startAppInsights method is from MS, do not reformat.
...
(function () {
  ...
  function startAppInsights(applicationKey) {
